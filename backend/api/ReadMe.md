...
1. use the endpoint generate-map to trigger an llm request; copy prompt string as a Json escaped string, use formatter website to convert, endpoint will retrun task id
