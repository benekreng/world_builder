...
- if you are not using a launch.json enter in terminal with venv activated: uvicorn api.main:app --reload  (this will start the FASTAPI_server)
...
- now you can see and test the available two endpoints:
